...
header 'ACLs with GATEWAY_SECURITY'
...
execute "step-11-LIST_TOPICS.sh" "List topics with consumer-sa not throw an error, but also no topic"
execute "step-12-SH.sh" "Let's give read-access to test-topic for consumer SA"
execute "step-13-CONSUME.sh" "Consuming from \`_acls\`"
