...
execute "step-06-CREATE_TOPICS.sh" "Creating topic topic-duplicate on teamA"
execute "step-07-ADD_INTERCEPTOR.sh" "Adding interceptor duplicate-messages"
...
execute "step-10-CONSUME.sh" "Let's consume the message, and confirm message was duplicated"
