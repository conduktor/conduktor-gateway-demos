...
<details>
  ...
  ![Creating topic `customers-shredding`](images/step-06-CREATE_TOPICS.gif)
...
<details>
  ...
  ![Adding interceptor `crypto-shredding-encrypt` in `gateway1`](images/step-08-ADD_INTERCEPTORS.gif)
...
```sh
{
  ...
  "password": "AAAABQAAAEl2YXVsdDp2MTo2bVhTZ3hqWGZTdUR3TVpHTTFzL3FLZlM4aWwyM096MkpmRDZVYjh2eUkzVFZrdGp4SWc1MklsNDJweW5Tdz09ie4QRYVHqK04uFzc6nCIYIA4khveo10mmlYP7PjFlemfv0/Y5UCq6JXlX6Q=",
  "visa": "AAAABQAAAEl2YXVsdDp2MTpyYzY4L2cxbDFNc2hVTk94T0ptTTRJNWIrNmtlbStOcFJKK2NLL202Z1BnVUZ4bzVVVzBDR0ZPMFpSMVN4QT09Wxlzgjt8gSu9LPX+dZdqnS73kwPxYqCyrn9lHm4mCJrjDttqYiX0y+pY",
  "address": "Chancery lane, London"
}
{
  "name": "florent",
  "username": "florent@conduktor.io",
  "password": "AAAABQAAAEl2YXVsdDp2MTplK2xEVnpHT0hudktVdnZ0TWdQdHV3Y05JZFZQTkJyZnZCS2lHbS9id0FTQjUzZHR6RkRNYW1FM3Z1Yjl2dz09xCkxinoSNatutl5wziyqmXd3nfXI7g5s9hUbnzopip02BpfNLHSqlSO/PA==",
  "visa": "AAAABQAAAEl2YXVsdDp2MTpiWVd0aWxvTTIyUmozTEUzbnpCVldyamtKeVUzSWIzNkpVMHAzbm02MmJNSDk2anc5TnlNVENBT3BXd3VSZz09jF4NA/1ZQP0KglQwCJtYuOHYmW88CRVbQtLcGdtRUB6y346anugH27Hz0vc=",
  "address": "Dubai, UAE"
}
...
<details>
  ...
  ![Adding interceptor `crypto-shredding-decrypt` in `gateway1`](images/step-12-ADD_INTERCEPTORS.gif)
...
<details>
  ...
  ![Cleanup the docker environment](images/step-18-DOCKER.gif)
