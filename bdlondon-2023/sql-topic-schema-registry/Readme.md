...
<details>
  ...
  ![Creating topic `cars`](images/step-06-CREATE_TOPICS.gif)
...
## Creating topic `red-cars`

Creating topic `red-cars` on `teamA`
* topic `red-cars` with partitions:1 replication-factor:1
...
<details>
  ...
  ![Creating topic `red-cars`](images/step-10-CREATE_TOPICS.gif)
...
<details>
  ...
  ![Adding interceptor `red-cars` in `gateway1`](images/step-11-ADD_INTERCEPTORS.gif)
