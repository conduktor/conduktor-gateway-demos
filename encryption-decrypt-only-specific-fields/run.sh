...
header 'Encryption, but decrypt only a set of fields'
...
execute "step-11-ADD_INTERCEPTOR.sh" "Adding interceptor decrypt"
execute "step-12-LIST_INTERCEPTORS.sh" "Listing interceptors for teamA"
execute "step-13-CONSUME.sh" "Confirm message from tom and laura are partially decrypted"
