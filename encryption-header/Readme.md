...
```
 Network encryption-header_default  Creating
 Network encryption-header_default  Created
...
![](images/encryption-header-step-04-DOCKER.gif)
...
security.protocol=SASL_PLAINTEXT
sasl.mechanism=PLAIN
sasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required username='sa' password='eyJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6InNhIiwidmNsdXN0ZXIiOiJ0ZWFtQSIsImV4cCI6MTcxODc4MDgyOX0.8Ux2Pi3RIe4owWfLImSzYHKyP9PKqRS9JePmK5P9hEo';
...
![](images/encryption-header-step-05-CREATE_VIRTUAL_CLUSTER.gif)
...
![](images/encryption-header-step-07-CREATE_TOPICS.gif)
...
cat: encryption: No such file or directory
cat: for: No such file or directory
cat: header.json: No such file or directory
...
![](images/encryption-header-step-08-ADD_INTERCEPTOR.gif)
...
![](images/encryption-header-step-09-ADD_INTERCEPTOR.gif)
...
![](images/encryption-header-step-10-LIST_INTERCEPTORS.gif)
...
```
org.apache.kafka.common.KafkaException: No header key separator found in pair ' London"}' on line number 1
	at kafka.tools.ConsoleProducer$LineMessageReader.$anonfun$splitHeaders$1(ConsoleProducer.scala:445)
	at scala.collection.ArrayOps$.map$extension(ArrayOps.scala:932)
	at kafka.tools.ConsoleProducer$LineMessageReader.kafka$tools$ConsoleProducer$LineMessageReader$$splitHeaders(ConsoleProducer.scala:443)
	at kafka.tools.ConsoleProducer$LineMessageReader$$anon$3.hasNext(ConsoleProducer.scala:419)
...
![](images/encryption-header-step-11-PRODUCE.gif)
...
![](images/encryption-header-step-12-PRODUCE.gif)

</details>

## Let's consume the message, and confirm `tom` header is decrypted in customers-fields-level-encryption topic
...
```json
[2024-03-21 14:07:24,150] ERROR Error processing message, terminating consumer process:  (kafka.tools.ConsoleConsumer$)
...
![](images/encryption-header-step-13-CONSUME.gif)
...
```json
[2024-03-21 14:07:35,536] ERROR Error processing message, terminating consumer process:  (kafka.tools.ConsoleConsumer$)
org.apache.kafka.common.errors.TimeoutException
Processed a total of 0 messages
...
![](images/encryption-header-step-14-CONSUME.gif)
...
![](images/encryption-header-step-15-ADD_INTERCEPTOR.gif)
...
![](images/encryption-header-step-16-LIST_INTERCEPTORS.gif)
...
```json
[2024-03-21 14:07:47,037] ERROR Error processing message, terminating consumer process:  (kafka.tools.ConsoleConsumer$)
org.apache.kafka.common.errors.TimeoutException
Processed a total of 0 messages
...
![](images/encryption-header-step-17-CONSUME.gif)

</details>

## Confirm header from `tom` is decrypted in customers-full-payload-level-encryption topic
...
```json
[2024-03-21 14:07:58,270] ERROR Error processing message, terminating consumer process:  (kafka.tools.ConsoleConsumer$)
org.apache.kafka.common.errors.TimeoutException
Processed a total of 0 messages
...
![](images/encryption-header-step-18-CONSUME.gif)
...
```
 ...
 Network encryption-header_default  Removing
 Network encryption-header_default  Removed
...
![](images/encryption-header-step-19-DOCKER.gif)
