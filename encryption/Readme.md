...
docker compose up --detach --wait
 Network encryption_default  Creating
 Network encryption_default  Created
...
security.protocol=SASL_PLAINTEXT
sasl.mechanism=PLAIN
sasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required username='sa' password='eyJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6InNhIiwidmNsdXN0ZXIiOiJ0ZWFtQSIsImV4cCI6MTcxMzcyMDk4MX0.yOcqUKiS3gRheit-Ajx18Y_DpQ-6_BJSHakewjrD9qk';
bootstrap.servers=localhost:6969
```
...
gateway_encrypted:
gateway_encrypted:
[2024-01-22 18:38:04,297] ERROR Error processing message, terminating consumer process:  (kafka.tools.ConsoleConsumer$)
org.apache.kafka.common.errors.TimeoutException
Processed a total of 2 messages
